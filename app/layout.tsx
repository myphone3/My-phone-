      ...
      <body className="bg-gray-50 min-h-screen text-gray-900">
        <header className="bg-white border-b sticky top-0 z-40 shadow-xs">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            {/* הצגת קובץ הלוגו בלבד ככפתור הבית */}
              ...
              {user ? (
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24">
                    ...
                    <path fill="#FBBC05" dt="M5.27 14.24c-.25-.72-.38-1.49-.38-2.24s.13-1.52.38-2.24V6.61H1.18C.43 8.13 0 9.87 0 11.76s.43 3.63 1.18 5.15l4.09-2.67z"/>
